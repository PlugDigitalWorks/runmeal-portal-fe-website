...
const REQUIRED_KEYS = [
  ...
  'contact.submitting',
  'contact.loading',
  'contact.validation.phoneFormat',
  'contact.validation.messageRequired',
  'contact.validation.messageMax',
  'contact.toast.success',
  'contact.toast.failed',
  'contact.authRequired.title',
  'contact.authRequired.description',
  'contact.authRequired.action',
  'contact.incompleteProfile.title',
  'contact.incompleteProfile.description',
  'contact.incompleteProfile.action',
  'contact.noBranch.title',
  'contact.noBranch.description',
  'contact.noBranch.action',
  'survey.tab',
  'survey.title',
  'survey.subtitle',
  'survey.loading',
  ...
  'survey.retry',
  'survey.loadMore',
  'survey.unknownBranch',
  'survey.answerAllHint',
  'survey.submit',
  'survey.submitting',
